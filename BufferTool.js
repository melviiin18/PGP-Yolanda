...
Ext.define('BufferTool', {
	...
	*/
	buffer: function(distance, unit, geom){
		...
		var wpsUrl='http://geoserver.namria.gov.ph/geoserver/wps'
		wpsUrl='/webapi/get.ashx?url=' + escape(wpsUrl)
		var wpsClient = new OpenLayers.WPSClient({
			servers: {
				//local: 'http://202.90.149.232/geoserver/wps'
				local: 'http://192.168.254.11:3000/geoserver.namria.gov.ph/geoserver/wps'
				//local: 'http://localhost:3000/geoserver.namria.gov.ph/geoserver/wps'
				//local:wpsUrl
				//local:'http://geoserver.namria.gov.ph'
			}
		});
