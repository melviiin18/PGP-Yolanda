	...
	buildButtons:function(){
		return[{
				...
				handler:function(){
					...
					//url = 'http://202.90.149.231:8000/earthquake.usgs.gov/earthquakes/feed/v1.0/summary/' + url 
					//url = '/webapi/get.ashx?url=http://www.earthquake.usgs.gov/earthquakes/v1.0/summary/' + url
					url = 'http://localhost:3000/earthquake.usgs.gov/earthquakes/feed/v1.0/summary/' + url 
